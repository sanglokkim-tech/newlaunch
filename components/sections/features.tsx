const FEATURES = [
  ...
  },
  {
    ...
    description: "Illuminate. Support. Focus. lifeOS reads your four pillars, balances the weight across all of them, and surfaces the one action that matters today.",
  },
  {
    color: "#2E7DD4",
    icon: (
